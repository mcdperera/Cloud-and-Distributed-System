...
public class Server {
    ...
    public List<String> firstPlayerLocations = new ArrayList<String>(5);

    // second player saved locations
    public List<String> secondPlayerLocations = new ArrayList<String>(5);
            ...
            while (keepGoing) {
                ...
                switch (gameMessage.getType()) {
                    ...
                    case GameMessage.PLAY_GAME:
                        ...
                        int playerWon = whichPlayerWon(firstPlayerLocations) ? 1
                                : (whichPlayerWon(secondPlayerLocations) ? 2 : 0);

                        if (firstPlayerLocations.size() == 5
                                || secondPlayerLocations.size() == 5) {
                        ...
                        switch (playerWon) {
                            case 0:
                                serverMessage = "No player won the game";

                                chatMessage = new GameMessage(GameMessage.PLAY_GAME,
                                        "", nextPlayingUsername, isFirstUser, gameMessage.getLocation());

                                break;
                            case -1:
                                serverMessage = "Game drawn";
                                ...
                                break;
                            default:
                                serverMessage = "Game won by user " + (playerWon == 1 ? FirstUsername : SecondUsername);
